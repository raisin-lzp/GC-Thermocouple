	...
	<div class="container-fluid">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li><a
					href="/productMass/typeF/id/<c:out value="${thisPageTypeF.typeID}"/>"><c:out
							value="${thisPageTypeF.name}" /></a></li>
		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<c:forEach items="${typeSProductMassList}" var="thisPageProductMass">
					<div class="col-sm-6 col-md-3">
						<div class="thumbnail">
							<img
								src="/images/productMass/product/productID_<c:out value="${thisPageProductMass.productID}" />.jpg"
								alt="<c:out
									value="${thisPageProductMass.productName}" />"
								style="border: 1px solid #645CDF;">
							<div class="caption">
								<h3>
									<c:out value="${thisPageProductMass.productName}" />
								</h3>
								<p>
									<c:out value="${thisPageProductMass.description}" />
								</p>
								<p>
									<a
										href="/productMass/id/<c:out value="${thisPageProductMass.productID}" />"
